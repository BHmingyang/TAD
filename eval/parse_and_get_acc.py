...
def parse_sudoku_answers(json_path=None, json_data=None):
    ...
    total_solved = total_processed = 0
    total_effective_tokens = 0
    processed_items = []
    ...
    for item in data.get("generations", []):
        ...
        solved = (
            ...
            and len(solution_str) == 16
            and len(ground_truth) == 16
            and empty_cells > 0
            and correct_cells == empty_cells
        )
        if solved:
            total_solved += 1
            print(f"Puzzle: {puzzle_str}")
            print(f"GT    : {ground_truth}")
            print(f"Pred  : {solution_str}")
            print("-" * 40)
...
if __name__ == "__main__":
    ...
    # aggregate_results(directory="save_dir/eval_results/eubo_eval_results_math_llada_spg_so_elbo_20260105_145030")
    # aggregate_results(directory="save_dir/eval_results/mix_eval_results_math_llada_spg_mix_20251221_205521")
    # aggregate_results(directory="save_dir/eval_results/eubo_eval_results_math_llada_spg_eubo_20251226_072542")
    # aggregate_results(directory="save_dir/eval_results/d1_eval_results_math_llada_d1_20251224_154054")
    # aggregate_results(directory="save_dir/eval_results/eubo_eval_results_math_llada_spg_so_early_elbo_20260105_195010")
    # aggregate_results(directory="save_dir/eval_results/elbo_eval_results_math_llada_spg_generated_so_elbo_20260109_143814")
    # aggregate_results(directory="save_dir/eval_results/elbo_eval_results_math_llada_spg_generated_so_elbo_20260110_104621")
    aggregate_results(directory="/home/u2025104115/LLaDA/eval/eval_results/")
